...
const RegisterPage = () => {
  ...
  const { mutateAsync, isSuccess, isPending } = useRegisterAccount<z.infer<typeof registerSchema>>(router);
        ...
        <div className="w-full max-w-lg">
          ...
          >
            <div className="flex w-full flex-col items-center">
              <Input className="m-2" {...register("username")} placeholder="Username" />
              {errors.username && (
            ...
            <div className="flex w-full flex-col items-center">
              <Input className="m-2" {...register("first_name")} placeholder="First name" />
              {errors.first_name && (
                <div className="mx-2 p-1">
            ...
            <div className="flex w-full flex-col items-center">
              <Input className="m-2" {...register("last_name")} placeholder="Last name" />
              {errors.last_name && (
                <div className="mx-2 p-1">
            ...
            <div className="flex w-full flex-col items-center">
              <Input type="password" className="m-2" {...register("password")} placeholder="Password" />
              {errors.password && (
                <div className="mx-2 p-1">
            ...
            <div className="flex w-full flex-col items-center">
              <Input type="password" className="m-2" {...register("confirm_password")} placeholder="Confirm password" />
